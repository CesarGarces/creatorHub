...
const agents = [
  {
    id: "youtube",
    name: "YouTube Agent",
    description: "Plan, script, and optimize your YouTube content with AI",
    icon: "🤖",
  ...
  },
  {
    id: "twitch",
    name: "Twitch Agent",
    description: "Manage your streaming content, overlays, and engagement",
    icon: "🎮",
  ...
  },
  {
    id: "content",
    name: "Content Agent",
    description: "Repurpose your content across multiple platforms",
    icon: "🧠",
