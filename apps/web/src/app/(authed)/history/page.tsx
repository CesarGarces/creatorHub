...
const mockHistory = [
  {
    id: "1",
    type: "thumbnail",
    title: "Gaming thumbnail with neon lights",
    credits: 10,
    date: "2 min ago",
    icon: "🖼️",
  ...
  },
  {
    id: "3",
    type: "title",
    title: "Top 10 React hooks for 2024",
    credits: 5,
    date: "3 hours ago",
    icon: "🎬",
  ...
  },
  {
    id: "5",
    type: "script",
    title: "YouTube channel trailer script",
    credits: 8,
    date: "Yesterday",
    icon: "📝",
    badge: "accent" as const,
        ...
        {filtered.length === 0 ? (
          ...
          <div className="rounded-xl border border-border bg-surface divide-y divide-border">
            {filtered.map((item) => (
              <div
                key={item.id}
                className="flex items-center gap-4 px-5 py-4 hover:bg-surface-elevated/50 transition-colors cursor-pointer"
              >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((item) => (
              <div
                key={item.id}
                className="rounded-xl border border-border bg-surface p-4 hover:border-border/80 transition-colors cursor-pointer"
              >
